...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=128, fcs2_units=128, fc1_units=400, fc2_units=300):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
        ...
        self.fc2 = nn.Linear(fcs1_units+fcs2_units, fc1_units)
